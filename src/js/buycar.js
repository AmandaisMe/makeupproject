$(function() {
    ...
    if (goods) {
        ...
        for (var i = 0; i < goods.length; i++) {
            ...
            $('<li/>').addClass('goodsmessage').html('<div>' + '<a>' + '<img src=' + goods[i].imgurl + '>' + '</a>' + '<span class="title">' + goods[i].title + '</span>' + '</div>' + '<div>' + '<span>' + goods[i].price + '</span>' + '<i class="less">' + "-" + '</i>' + '<strong class="num">' + goods[i].qty + '</strong>' + '<em class="add">' + "+" + '</em>' + '</span >' + '<span class="total">' + goods[i].price * goods[i].qty + '</span>' + '<span>' + '<strong>' + '删除' +
